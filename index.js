...
bot.start(async (ctx) => {
  ...
  if (refId) {
    ...
    if (isValidReferral) {
      console.log(`Referral ID ${refId} is valid. Proceed with referral logic.`);
      ctx.replyWithHTML(`Welcome to sunflower ${ctx.from.username} \n\n <b>You were referred by ${isValidReferral.username}</b> \n\nLaunch the app by clicking the launch button`, {
        reply_markup: {
            inline_keyboard: [
                [Markup.button.webApp("Launch", `https://tg-front-eight.vercel.app?referralCode=${refId}`)]
            ]
        }
      })
    } else {
      console.log(`Referral ID ${refId} is not valid.`);
      ctx.replyWithHTML(`Welcome to Sunflower bot ${ctx.from.username} \n\n <b>Your referral Link is invalid!!</b> \n\n Launch the app by clicking the launch button`, {
        reply_markup: {
            inline_keyboard: [
                [Markup.button.webApp("Launch", `https://tg-front-eight.vercel.app`)]
            ]
        }
      })
    ...
    ctx.reply(`Welcome to Sunflower bot ${ctx.from.username} \n\n Launch the app by clicking the launch button`, {
        reply_markup: {
            inline_keyboard: [
                [Markup.button.webApp("Launch", `https://tg-front-eight.vercel.app`)]
            ]
